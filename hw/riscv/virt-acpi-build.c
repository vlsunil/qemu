                       ...
                       RISCVVirtState *s)
{
    ...
    /* CMO node */
    /* TODO: Check extension present and then only populate fields */
    ...
    build_append_int_noprefix(table_data, 0x1, 2);   /* Revision */
    build_append_int_noprefix(table_data, 6, 2);    /* CBOM Block Size - 64 bytes */
    build_append_int_noprefix(table_data, 6, 2);    /* CBOP Block Size - 64 bytes */
    build_append_int_noprefix(table_data, 6, 2);    /* CBOZ Block Size - 64 bytes */
